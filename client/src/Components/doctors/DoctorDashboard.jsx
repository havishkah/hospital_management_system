			...
			<div className="second-card">
				<div className="big-card">
					...
					<div className="article">
						...
						<small>
							The purpose of the two vaccines is actually
							different, yes the first <span>(vaccine)</span>{" "}
							is to see the body's response.new the
							second(vaccine) is to form immunity(body)
						</small>
					</div>
				</div>
				...
				<div
					...
					className="card">
					<h5 style={{ color: "red", fontSize: "25px" }}>
						Available Doctors
					</h5>
					<div className="card-inner">
						...
						<i
							style={{ fontSize: "80px" }}
							class="fa-solid fa-user-doctor card_icon"></i>
					</div>
				</div>
			</div>
		</main>
